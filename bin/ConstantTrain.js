...
cstrain_core_Card.__name__ = ["cstrain","core","Card"];
...
cstrain_core_Card.prototype = {
	__class__: cstrain_core_Card
};
...
cstrain_core_Deck.__name__ = ["cstrain","core","Deck"];
...
cstrain_core_Deck.prototype = {
	...
	,__class__: cstrain_core_Deck
};
var cstrain_core_IRules = function() { };
cstrain_core_IRules.__name__ = ["cstrain","core","IRules"];
cstrain_core_IRules.prototype = {
	__class__: cstrain_core_IRules
};
...
cstrain_core_Polynomial.__name__ = ["cstrain","core","Polynomial"];
...
cstrain_core_Polynomial.prototype = {
	...
	,isZero: function() {
		if(this.coefs.length - 1 == 0) {
			return (this.coefs.length - 1 < 0 ? null : this.coefs[0]) == 0;
		} else {
			return false;
		}
	}
	,addCoef: function(i,value) {
		var oldCoef = this.coefs.length - 1 < i ? null : this.coefs[i];
		if(oldCoef == null) {
			oldCoef = 0;
		}
	...
	,divisionWithRemainder: function(b) {
		if(b.isZero()) {
			throw new js__$Boot_HaxeError("divisionWithRemainder:: / by zero");
		}
		var result = [];
		var a = this;
		...
		while(deg >= 0 && !a.isZero()) {
			var i = a.coefs.length - 1;
			var coefA = a.coefs.length - 1 < i ? null : a.coefs[i];
			var i1 = b.coefs.length - 1;
			var coefB = b.coefs.length - 1 < i1 ? null : b.coefs[i1];
	...
	,mul: function(b) {
		...
		while(_g1 < _g) {
			...
			while(_g3 < _g2) {
				var j = _g3++;
				var termA = this.coefs.length - 1 < i ? null : this.coefs[i];
				var termB = b.coefs.length - 1 < j ? null : b.coefs[j];
	...
	,__class__: cstrain_core_Polynomial
};
var cstrain_rules_TestGame = function() {
	this.polynomialValueCached = false;
	this.restart();
};
cstrain_rules_TestGame.__name__ = ["cstrain","rules","TestGame"];
...
cstrain_rules_TestGame.prototype = {
	...
	,getSecretValue: function() {
		if(this.polynomialValueCached) {
			...
			return this.polynomialValue = this.polynomial.evalValueInt(this.secretVarValue);
		}
	}
	,buildDeck: function() {
	...
	,getCardResult: function(isSwipeRight) {
		...
		if(curCard.operator <= 3) {
			...
			var c = !this.wildGuess ? this.polynomial.coefs[0] | 0 : this.polynomialValueCached ? this.polynomialValue : this.polynomialValue = this.polynomial.evalValueInt(this.secretVarValue);
	...
	,playCard: function(isSwipeRight) {
		...
		case 1:
			...
			case 0:case 1:
				...
				break;
			case 3:case 4:
				var v = this.wildGuess ? this.polynomialValueCached ? this.polynomialValue : this.polynomialValue = this.polynomial.evalValueInt(this.secretVarValue) : this.polynomial.coefs[0] | 0;
				var to = this.polynomialValueCached ? this.polynomialValue : this.polynomialValue = this.polynomial.evalValueInt(this.secretVarValue);
	...
	,__class__: cstrain_rules_TestGame
};
...
cstrain_vuex_components_CardView.__name__ = ["cstrain","vuex","components","CardView"];
...
cstrain_vuex_components_CardView.prototype = $extend(haxevx_vuex_core_VxComponent.prototype,{
	swipe: function(isRight) {
		var _this = cstrain_vuex_components_CardView.actions;
		var context = this.$store;
		context.dispatch("cstrain_vuex_game_GameActions|swipe",isRight,null);
	}
	,Template: function() {
	...
	,_Init: function() {
		...
		haxevx_vuex_core_Singletons.addLookup(haxevx_vuex_core_Singletons.getClassNameOfInstance(new cstrain_vuex_game_GameActions()),"cstrain.vuex.components.CardView");
	}
	,__class__: cstrain_vuex_components_CardView
});
var cstrain_vuex_components_GameView = function() {
	haxevx_vuex_core_VxComponent.call(this);
};
cstrain_vuex_components_GameView.__name__ = ["cstrain","vuex","components","GameView"];
...
cstrain_vuex_components_GameView.prototype = $extend(haxevx_vuex_core_VxComponent.prototype,{
	...
	,Created: function() {
		var _this = cstrain_vuex_components_GameView.mutator;
		var context = this.$store;
		context.commit("cstrain_vuex_game_GameMutator|resume",null,null);
	}
	,toggleExpression: function() {
		var _this = cstrain_vuex_components_GameView.mutator;
		var context = this.$store;
		context.commit("cstrain_vuex_game_GameMutator|showOrHideExpression",null,null);
	}
	,Template: function() {
	...
	,_Init: function() {
		...
		haxevx_vuex_core_Singletons.addLookup(haxevx_vuex_core_Singletons.getClassNameOfInstance(new cstrain_vuex_game_GameMutator()),"cstrain.vuex.components.GameView");
	}
	,__class__: cstrain_vuex_components_GameView
});
...
cstrain_vuex_game_GameActions.__name__ = ["cstrain","vuex","game","GameActions"];
cstrain_vuex_game_GameActions.prototype = {
	swipe: function(context,isRight) {
		var result = context.state._rules.playCard(isRight);
		switch(result[1]) {
		case 0:
			var _this = cstrain_vuex_game_GameActions.mutator;
			context.commit("cstrain_vuex_game_GameMutator|resume",null,null);
			break;
		case 1:
			var penalty = result[2];
			if(penalty.delayNow != null) {
				var _this1 = cstrain_vuex_game_GameActions.mutator;
				var delay = penalty.delayNow;
				context.commit("cstrain_vuex_game_GameMutator|setDelay",delay,null);
			}
			var _this2 = cstrain_vuex_game_GameActions.mutator;
			context.commit("cstrain_vuex_game_GameMutator|resume",null,null);
			break;
		case 2:
			var wildGuessing = result[3];
			var guessCard = result[2];
			var _this3 = cstrain_vuex_game_GameActions.mutator;
			context.commit("cstrain_vuex_game_GameMutator|setPopupCard",true,null);
			var _this4 = cstrain_vuex_game_GameActions.mutator;
			context.commit("cstrain_vuex_game_GameMutator|resume",null,null);
			break;
		default:
			console.log("Uncaught case: " + Std.string(result));
		}
		var _this5 = cstrain_vuex_game_GameActions.mutator;
		context.commit("cstrain_vuex_game_GameMutator|traceCardResult",result,null);
	}
	,_swipe: function(context,isRight,opts,ns) {
		if(ns == null) {
			ns = "";
		}
		if(ns != "") {
			context.dispatch(ns + "cstrain_vuex_game_GameActions|swipe",isRight,opts);
		} else {
			context.dispatch("cstrain_vuex_game_GameActions|swipe",isRight,opts);
		}
	}
	,_SetInto: function(d,ns) {
		...
		haxevx_vuex_core_Singletons.addLookup(haxevx_vuex_core_Singletons.getClassNameOfInstance(new cstrain_vuex_game_GameMutator()),"cstrain.vuex.game.GameActions");
	}
	,__class__: cstrain_vuex_game_GameActions
};
var haxevx_vuex_core_IGetters = function() { };
haxevx_vuex_core_IGetters.__name__ = ["haxevx","vuex","core","IGetters"];
var cstrain_vuex_game_GameGetters = function() {
};
cstrain_vuex_game_GameGetters.__name__ = ["cstrain","vuex","game","GameGetters"];
...
cstrain_vuex_game_GameGetters.prototype = {
	...
	,__class__: cstrain_vuex_game_GameGetters
};
...
cstrain_vuex_game_GameModule.__name__ = ["cstrain","vuex","game","GameModule"];
...
cstrain_vuex_game_GameModule.prototype = $extend(haxevx_vuex_core_VModule.prototype,{
	...
	,_Init: function(ns) {
		...
		d = { };
		this.mutations = d;
		haxevx_vuex_core_Singletons.setAsSingleton(new cstrain_vuex_game_GameMutator())._SetInto(d,"");
		d = { };
		this.actions = d;
		haxevx_vuex_core_Singletons.setAsSingleton(new cstrain_vuex_game_GameActions())._SetInto(d,"");
	}
	,__class__: cstrain_vuex_game_GameModule
});
...
cstrain_vuex_game_GameMutator.__name__ = ["cstrain","vuex","game","GameMutator"];
...
cstrain_vuex_game_GameMutator.prototype = {
	...
	,_restart: function(context,opts,ns) {
		if(ns == null) {
			ns = "";
		}
		if(ns != "") {
			context.commit(ns + "cstrain_vuex_game_GameMutator|restart",null,opts);
		} else {
			context.commit("cstrain_vuex_game_GameMutator|restart",null,opts);
		}
	}
	,_setPopupCard: function(context,isPopup,opts,ns) {
		if(ns == null) {
			ns = "";
		}
		if(isPopup == null) {
		...
		if(ns != "") {
			context.commit(ns + "cstrain_vuex_game_GameMutator|setPopupCard",isPopup,opts);
		} else {
			context.commit("cstrain_vuex_game_GameMutator|setPopupCard",isPopup,opts);
		}
	}
	,_setDelay: function(context,delay,opts,ns) {
		if(ns == null) {
			ns = "";
		}
		if(ns != "") {
			context.commit(ns + "cstrain_vuex_game_GameMutator|setDelay",delay,opts);
		} else {
			context.commit("cstrain_vuex_game_GameMutator|setDelay",delay,opts);
		}
	}
	,_traceCardResult: function(context,result,opts,ns) {
		if(ns == null) {
			ns = "";
		}
		if(ns != "") {
			context.commit(ns + "cstrain_vuex_game_GameMutator|traceCardResult",result,opts);
		} else {
			context.commit("cstrain_vuex_game_GameMutator|traceCardResult",result,opts);
		}
	}
	,_resume: function(context,opts,ns) {
		if(ns == null) {
			ns = "";
		}
		if(ns != "") {
			context.commit(ns + "cstrain_vuex_game_GameMutator|resume",null,opts);
		} else {
			context.commit("cstrain_vuex_game_GameMutator|resume",null,opts);
		}
	}
	,_showOrHideExpression: function(context,showExpression,opts,ns) {
		if(ns == null) {
			ns = "";
		}
		if(ns != "") {
			context.commit(ns + "cstrain_vuex_game_GameMutator|showOrHideExpression",showExpression,opts);
		} else {
			context.commit("cstrain_vuex_game_GameMutator|showOrHideExpression",showExpression,opts);
		}
	}
	,_SetInto: function(d,ns) {
	...
	,__class__: cstrain_vuex_game_GameMutator
};
...
cstrain_vuex_game_GameState.__name__ = ["cstrain","vuex","game","GameState"];
cstrain_vuex_game_GameState.prototype = {
	__class__: cstrain_vuex_game_GameState
};
...
cstrain_vuex_store_GameStore.__name__ = ["cstrain","vuex","store","GameStore"];
...
cstrain_vuex_store_GameStore.prototype = $extend(haxevx_vuex_core_VxStore.prototype,{
	...
	,__class__: cstrain_vuex_store_GameStore
});
var cstrain_vuex_store_GameStoreState = function() {
};
cstrain_vuex_store_GameStoreState.__name__ = ["cstrain","vuex","store","GameStoreState"];
cstrain_vuex_store_GameStoreState.prototype = {
	__class__: cstrain_vuex_store_GameStoreState
};
